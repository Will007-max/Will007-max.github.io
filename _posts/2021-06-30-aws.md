...
As you can see on the following figure, I added two rules: to allow SSH on port 22
only from my IP address, and another rule to authorize any any user to access to a web
server installed on this instance.
