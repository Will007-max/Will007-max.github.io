...
- *Linux* represents the operating system, and it manages the available resources
...
![Image](/assets/images/aws_rds_creating.png#center)

### 6.2. A virtual machine to install Linux (Amazon EC2), Apache and PHPMyAdmin

To install a web site server, different command lines are required to be entered :
