...
### 7.1. Installation, configuration and basic commands
...
- Create and/or delete a key pair, used for accessing instances
...
To delete the key pair, you just need to type the following command:

```js
aws ec2 delete-key-pair --key-name cliKeyAws
```
...
### 7.2. S3 - Simple Storage

- Create a bucket

- Kill a bucket

- Use the AWS command line to interact with buckets
