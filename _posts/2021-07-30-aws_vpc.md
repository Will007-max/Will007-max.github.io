...
When creating a VPC, there is a network access control list (Network ACL). As shown
in the following figures, by default, as *Inbound Rules* or *Outbound Rules*, it is
ALLOW ALL (ALL Traffic Type, ALL Protocol, ALL Port Range, ALL Source, ALL Destination)
